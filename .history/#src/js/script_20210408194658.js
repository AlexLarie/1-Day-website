...
for (let i=0; i<icons.length; i++){
   icons[i].addEventListener('mouseenter', (e)=>{
      console.log(e.target.firstElementChild.getAttribute('fill'))
      e.target.firstElementChild.setAttribute('fill', 'red')
   })
}
for (let i=0; i<icons.length; i++){
   icons[i].addEventListener('mouseleave', (e)=>{
      console.log(e.target)
      e.target.firstElementChild.setAttribute('fill', 'gray')
   })
}
