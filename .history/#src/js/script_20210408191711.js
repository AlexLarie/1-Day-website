...
let icons = document.querySelectorAll('.nav__item');
for (let i=0; i<icons.length; i++){
   icons[i].addEventListener('mouseenter', (e)=>{
      e.target.firstElementChild.firstElementChild.firstElementChild.setAttribute('fill', 'red')
   })
}
for (let i=0; i<icons.length; i++){
   icons[i].addEventListener('mouseleave', (e)=>{
      e.target.firstElementChild.firstElementChild.firstElementChild.setAttribute('fill', 'gray')
   })
}
...
let burgerButton = document.querySelector('.burger__right');
